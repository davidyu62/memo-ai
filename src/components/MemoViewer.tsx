...
// Markdown 컴포넌트를 동적 import로 로드 (SSR 방지)
          ...
          <div className="mb-6">
            <div className="flex items-center justify-between mb-3">
              ...
              <button
                ...
                className="inline-flex items-center px-3 py-1.5 text-sm font-medium text-blue-600 bg-blue-50 hover:bg-blue-100 rounded-lg transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
              >
                {isSummarizing ? (
                  <>
                    <svg
